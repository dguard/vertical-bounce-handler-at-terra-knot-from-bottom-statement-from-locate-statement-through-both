...
function KnotPointerBelongingsFromBottomStatement() {
    ...
    that.compute = function () {
        ...
        // keep !
        that.passThrough(constructedPointerBelongings, knotLocateStickedFromBottomStatement.throughKnot)
...
function KnotFromBottomStatement(pencil) {
    ...
    that.throughCtx = function (ctx) {
        ...
        knotFromBottomStatement.ctx.addEventListener('click', function (event) {
            ...
            let knotPointerBelongings = (new KnotPointerBelongingsFromBottomStatement()).throughPointerBelongings(pointerBelongings)

            knotPointerBelongings.compute()

            accuratePencil.rememberAccurateSample(sceneSpawnPointerBelongings, knotPointerBelongings.throughSpawnedPointerBelongings(pointerBelongings))
            accuratePencil.useScene(sceneSpawnPointerBelongings)
