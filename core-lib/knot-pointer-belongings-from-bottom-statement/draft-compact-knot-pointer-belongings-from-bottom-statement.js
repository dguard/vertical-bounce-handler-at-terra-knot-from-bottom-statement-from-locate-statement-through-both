...
function RectangleOnPaper(radius, frontRatio, p, d, debthScaleRatio, profileScaleRatio, frontScaleRatio) {
    ...
    const FIELD_OF_VIEW = window['@pencil/draft-knot-locate-sticked-from-bottom-statement']['passThroughFromBottom']['FIELD_OF_VIEW']

    const PROJECTION_CENTER_Y = window['@pencil/draft-knot-locate-sticked-from-bottom-statement']['passThroughFromBottom']['PROJECTION_CENTER_Y']

    const PROJECTION_CENTER_X = window['@pencil/draft-knot-locate-sticked-from-bottom-statement']['passThroughFromBottom']['PROJECTION_CENTER_X']
    ...
    that.drawFromBottom = function () {
        ...
        const handleProjectAt1stIteration = window['@pencil/handle-knot-locate-sticked-from-bottom-statement']['handleProjectAt1stIteration']
        const handleProjectAt2ndIteration = window['@pencil/handle-knot-locate-sticked-from-bottom-statement']['handleProjectAt2ndIteration']
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            let ctx = window['@pencil/draft-knot-locate-sticked-from-bottom-statement']['passThroughFromBottom']['canvas']
...
window['@pencil/draft-compact-knot-locate-sticked-from-bottom-statement'] = {
    DraftFabrikk,
    Pencil
}
